...
如果没有参照，仅设置元素的上边为常量20.0pt毫无意义。因此约束位置时，参照是必须的。例如，元素的上边位于父视图上边下方20.0pt处。然而，元素的高度为20.0pt就没问题。更多信息，详见章节[数值解释](https://developer.apple.com/library/content/documentation/UserExperience/Conceptual/AutolayoutPG/AnatomyofaConstraint.html#//apple_ref/doc/uid/TP40010853-CH9-SW22)。
