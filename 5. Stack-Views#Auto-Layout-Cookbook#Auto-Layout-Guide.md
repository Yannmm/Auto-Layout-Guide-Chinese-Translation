...
本节通过实例展示堆叠视图的使用，界面复杂程度不断上升。堆叠视图能够有效降低界面复杂度，加快搭建速度；通过调整其各项属性，做到精细布局。此外，还可以在此基础上进一步添加约束，实现预期效果；然而布局复杂度也会因此上升。
...
更多关于固定子视图填充父视图的信息，详见章节[Simple Single View（简单独立视图）](https://developer.apple.com/library/content/documentation/UserExperience/Conceptual/AutolayoutPG/WorkingwithSimpleConstraints.html#//apple_ref/doc/uid/TP40010853-CH12-SW5)以及[Adaptive Single View（自适应独立视图）](https://developer.apple.com/library/content/documentation/UserExperience/Conceptual/AutolayoutPG/WorkingwithSimpleConstraints.html#//apple_ref/doc/uid/TP40010853-CH12-SW4)。
...
我们首先搭建视图结构，再添加额外约束，详见下一章节[Views and Constraints（搭建布局）](https://developer.apple.com/library/content/documentation/UserExperience/Conceptual/AutolayoutPG/LayoutUsingStackViews.html#//apple_ref/doc/uid/TP40010853-CH11-SW12)。
